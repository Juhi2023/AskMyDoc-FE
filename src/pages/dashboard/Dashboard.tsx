...
import type { UserStats, DocumentListResponse } from '@/types';
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
                <Link to="/dashboard/documents" className="card-hover flex items-center gap-4 group">
                ...
                <Link to="/dashboard/chat" className="card-hover flex items-center gap-4 group">
            ...
            <div>
                <div className="flex items-center justify-between mb-4">
                    ...
                    <Link to="/dashboard/documents" className="text-primary-400 hover:text-primary-300 text-sm font-medium">
                        View All →
                    </Link>
                </div>
                ...
                `}>
                    ...
                    <div className="card text-center py-12">
                        ...
                        <Link to="/dashboard/documents" className="btn-primary inline-flex items-center gap-2">
