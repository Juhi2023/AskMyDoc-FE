                    ...
                    <div className="bg-dark-800/50 border border-dark-700 rounded-2xl p-8 space-y-8">
                        <section>
                            ...
                            <p className="text-dark-300 leading-relaxed">
                                By accessing or using AskMyDoc, you agree to be bound by these Terms of Service.
                        ...
                        <section>
                            ...
                            <p className="text-dark-300 leading-relaxed">
                                AskMyDoc provides an AI-powered document intelligence platform that allows users to
                        ...
                        <section>
                            ...
                            <p className="text-dark-300 leading-relaxed">
                                AskMyDoc is provided &quot;as is&quot; without warranties of any kind. We are not liable for
                        ...
                        <section>
                            ...
                            <p className="text-dark-300 leading-relaxed">
                                ...
                                <a href="mailto:legal@askmydoc.ai" className="text-primary-400 hover:text-primary-300">
                                    legal@askmydoc.ai
                                </a>
                            </p>
                        </section>
