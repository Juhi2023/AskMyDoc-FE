...
import { File, Mail, Lock, User, Loader2, Eye, EyeOff, CheckCircle, ArrowRight, Sparkles, Shield, Zap } from 'lucide-react';
                    ...
                    <div className="max-w-lg ml-8">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                ...
                                { icon: File, title: 'Multi-Format', desc: 'PDF, DOCX, TXT & more' },
                            ].map((feature) => (
                                <div
                                    key={feature.title}
